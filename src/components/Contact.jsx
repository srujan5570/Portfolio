...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        import.meta.env.service_02i0l1v,
        import.meta.env.template_8b0ph1i,
        {
          name: form.name,
          to_name: "Banavath Srujan",
          email: form.email,
          to_email: "banavathsrujan11@gmail.com",
          message: form.message,
        },
        import.meta.env.Q6_dFVBmTFx496k2p
      )
      .then(
        () => {
          setLoading(false);
